...
<Info>
  Commercial facilities provide a way for organizations to group and track multiple physical facilities under a single logical entity. While regulatory facilities (batteries, terminals, etc.) each have unique IDs and locations, commercial facilities allow organizations to combine these into meaningful business units for marketing, stakeholder reporting, and internal tracking purposes. For example, multiple batteries with different regulator IDs might be grouped into one commercial facility that represents how the organization refers to that location internally.
</Info>
...
<Info>
Each facility is unique by their `regulator_id` (e.g. ABBT0030001), `jurisdiction` (e.g. Alberta), and 'regulator\_system' (e.g. Petrinex) and is primarily used for production accounting purposes.
</Info>
...
<Info>
Each facility is unique by their `regulator_id` (e.g. ABBT0030001), `jurisdiction` (e.g. Alberta), and `regulator_system` (e.g. Petrinex) and is primarily used for production accounting purposes.
</Info>
