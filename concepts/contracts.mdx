...
- **Contract**: The central element of a commercial agreement, encompassing:
  ...
  - **Parties Involved**: Includes various roles such as Seller, Buyer, Producer, and Negotiator, each with specific responsibilities and permissions.
  ...
  - **Linked Message Threads**: For communication between parties.

- **Schedule**: Details the production months and associated line items for the contract.

- **Line Item**: Specifies the product, volume, pricing basis, and other relevant information.

- **Contract Paper**: Legal documents and general terms and conditions that provide the legal framework for the contract.

Each contract is associated with a **Deal**, which groups multiple contracts together to represent a trader's strategy. Contracts are linked to a **Deal** and can have various **Parties** involved, each with specific roles such as Seller, Buyer, Producer, and Negotiator. Additionally, contracts can include **Profit Shares** that specify the percentage of profit to be shared among the parties involved.
