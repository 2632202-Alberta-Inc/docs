...
<Info>
  ...
  multiple facilities under a single entry. While every facility (batteries,
  terminals, etc.) has a unique `regulator_id`'s, commercial facilities allow
  organizations to combine multiple facilities into meaningful business units
  for marketing, stakeholder reporting, internal tracking purposes, etc.
</Info>
