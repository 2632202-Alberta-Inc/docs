...
### Streams (Commercial Representation)

Streams represent standardized market classifications with strict quality requirements that must be met for sale and delivery:

- Mixed Sweet Blend (MSW)
- Premium Condensate
- Light Sour Blend

#### Stream Specifications (Commercial Requirements)

Each stream has mandatory specifications that must be met for commercial delivery. For example, to sell a blended product as MSW, it must precisely meet MSW stream specifications - there is no flexibility in these requirements.
...
These lookup systems are essential for:
